...
const services = [
  {
    ...
    description: "Solar film tuned for Dera Ghazi Khan heat, glare and daily cabin comfort.",
    ...
    <div className="aura-page">
      <header className={`site-nav ${scrolled ? "scrolled" : ""}`}>
        <div className="container nav-inner">
          <a className="brand-lockup" href="#top" onClick={() => setMenuOpen(false)} aria-label="Wrap.X home">
            <img className="brand-mark" src={publicAssets.monogram} alt="" />
            <span>
              <span className="brand-name">WRAP.X</span>
      ...
      <main id="top">
        <section className="hero">
          ...
          <div className="container hero-content">
            <div className="hero-kicker eyebrow">Automotive protection / Dera Ghazi Khan</div>
            ...
            <div className="hero-actions">
              <button className="aura-btn" onClick={() => setBookingOpen(true)}>Book your service</button>
              <a className="aura-btn aura-btn-outline" href="#services">Explore services</a>
            </div>
          </div>
          <div className="hero-location">College Chowk, Jampur Road, D.G. Khan</div>
          <a className="scroll-cue" href="#services" aria-label="Scroll to services">Scroll to explore</a>
        </section>
          ...
          <div className="container">
            <div className="feature-wrap reveal">
              <div className="feature-copy">
                ...
                <button className="aura-btn aura-btn-outline" onClick={() => { setBookingOpen(true); toast("Window tint consultation selected"); }}>Explore window tints</button>
              </div>
        ...
        <section className="section section-dark" id="why-aura">
          <div className="container why-layout">
            <div className="why-title reveal">
              <SectionMarker index="03" label="The Wrap.X standard" />
              <h2>Why<br />Wrap.X?</h2>
              <p>Because the difference is not one big gesture. It is the standard held across every surface, every edge, every handoff.</p>
              <div className="why-quote">“The finish should feel inevitable.”<br />WRAP.X STUDIO NOTE / 001</div>
            </div>
        ...
        <section className="section section-graphite comparison-section" id="difference">
          <div className="container">
            <div className="section-head reveal">
              ...
              <p>Drag across the finish to see the visual language of a Wrap.X treatment, clarity, depth and a sharper reflection.</p>
            </div>
        ...
        <section className="section section-dark" id="gallery">
          <div className="container">
            <div className="section-head reveal">
              ...
              <p>A closer look at the finishes, materials and quiet precision behind the WRAP.X standard.</p>
            </div>
        ...
        <section className="section testimonials" id="standard">
          <div className="container">
            ...
            <div className="testimonial-grid">
              ...
              ].map(([number, title, copy]) => <article className="testimonial reveal" key={number}><div className="stars">WRAP.X / {number}</div><blockquote>{title}</blockquote><p style={{ color: "var(--aura-ash)", fontSize: "0.82rem", lineHeight: 1.6, margin: 0 }}>{copy}</p><footer><strong>Studio standard</strong><span>College Chowk / D.G. Khan</span></footer></article>)}
            </div>
          </div>
        </section>
        ...
        <section className="final-cta" id="contact">
          ...
          <div className="container final-content reveal">
            ...
            <h2>Your car<br />deserves <span>Wrap.X.</span></h2>
            <p>Premium detailing. Advanced protection. Uncompromising results.</p>
            <div className="final-actions"><button className="aura-btn" onClick={() => setBookingOpen(true)}>Book your appointment</button><a className="aura-btn aura-btn-outline" href="mailto:info@wrapx.pk">Contact us</a></div>
          </div>
        </section>
      </main>
      ...
      <footer className="site-footer">
        <div className="container">
          <div className="footer-grid">
            <div className="footer-brand"><a className="brand-lockup" href="#top"><img className="brand-mark" src={publicAssets.monogram} alt="Wrap.X monogram" /><span><span className="brand-name">WRAP.X</span><span className="brand-sub">BETTER COMFORT. BETTER DRIVES.</span></span></a><p>Premium automotive protection, detailing & styling, crafted for the drive ahead.</p></div>
            ...
            <div><p className="footer-heading">Studio / Contact</p><div className="footer-contact"><a href="https://maps.google.com/?q=College+Chowk+Jampur+Road+Dera+Ghazi+Khan" target="_blank" rel="noreferrer">College Chowk, Jampur Road Dera Ghazi Khan, 32200</a><a href="https://instagram.com/wrapx.pk" target="_blank" rel="noreferrer">@wrapx.pk</a><a href="mailto:info@wrapx.pk">info@wrapx.pk</a></div></div>
          </div>
          <div className="footer-bottom"><span>© 2026 WRAP.X</span><span>Built for better drives.</span></div>
        </div>
      </footer>
